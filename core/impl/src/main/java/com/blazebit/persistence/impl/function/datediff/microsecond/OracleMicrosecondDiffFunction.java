 ...
 * @since 1.4.0
 */
public class OracleMicrosecondDiffFunction extends MicrosecondDiffFunction {
    ...
    public OracleMicrosecondDiffFunction() {
        super("1000000 * (extract(second from cast(?2 as timestamp) - cast(?1 as timestamp))" +
        ...
        this.firstParamRenderer = new TemplateRenderer("(select 1000000 * (extract(second from cast(?2 as timestamp) - t1)" +
        ...
        this.secondParamRenderer = new TemplateRenderer("(select 1000000 * (extract(second from t2 - cast(?1 as timestamp))" +
