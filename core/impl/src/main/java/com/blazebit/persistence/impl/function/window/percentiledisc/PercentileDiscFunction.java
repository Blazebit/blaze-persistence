...
package com.blazebit.persistence.impl.function.window.percentiledisc;
...
public class PercentileDiscFunction extends AbstractWindowFunction {
    ...
    public static final String FUNCTION_NAME = "PERCENTILE_DISC";

    public PercentileDiscFunction(DbmsDialect dbmsDialect) {
