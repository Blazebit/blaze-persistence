...
public class HavingTest extends AbstractCoreTest {
    ...
    public void testHavingSize(){
        ...
        final String expected = "SELECT d.id FROM Document d LEFT JOIN d.partners partners_1 GROUP BY d.id HAVING " + function("COUNT_TUPLE", "d.id", "partners_1") + " > 1";
        assertEquals(expected, criteria.getQueryString());
        criteria.getResultList();
    }
    ...
    public void testHavingSizeMultiple(){
        ...
        final String expected = "SELECT d.id FROM Document d LEFT JOIN d.partners partners_1 LEFT JOIN d.versions versions_1 GROUP BY d.id HAVING " + function("COUNT_TUPLE", "'DISTINCT'", "d.id", "partners_1") + " > 1 AND " + function("COUNT_TUPLE", "'DISTINCT'", "d.id", "versions_1") + " > 2";
        assertEquals(expected, criteria.getQueryString());
        criteria.getResultList();
    }
