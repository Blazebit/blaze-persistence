...
public class DateDiffTest extends AbstractCoreTest {
    ...
    public void testDateSelfDiff() {
        ...
        assertEquals(0L, actual.get(5));
        assertEquals(0L, actual.get(6));
        assertEquals(0L, actual.get(7));
    ...
    public static long microsecondsBetween(Calendar day1, Calendar day2) {
        return (day2.getTimeInMillis() - day1.getTimeInMillis()) * 1000L;
    }
    
    public static long secondsBetween(Calendar day1, Calendar day2) {
        return daysBetween(day1, day2) * 24L * 60L * 60L
                + (day2.get(Calendar.HOUR) - day1.get(Calendar.HOUR)) * 60L * 60L
                + (day2.get(Calendar.MINUTE) - day1.get(Calendar.MINUTE)) * 60L
    ...
    public static int yearsBetween(Calendar day1, Calendar day2) {
        return monthsBetween(day1, day2) / 12;
    }
}
