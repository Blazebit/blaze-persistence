 ...
 * 
 * <p>
 * This builder allows the specification of the upper bound of the between predicate.
 * The left hand side expression of the between predicate as well as the lower bound
 * expression are already known to the builder and the methods of this builder either
...
public interface BetweenBuilder<T> {
     ...
     * This allows to build expressions containing subqueries like following example shows:
     * </p>
     * 
     * <p>
