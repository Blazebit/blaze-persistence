...
[.releases]
|===
| 1.6.17        | 2025-09-03     | https://github.com/Blazebit/blaze-persistence/releases/download/1.6.17/blaze-persistence-dist-1.6.17.zip[*Download*, window="_blank"] | link:news/2025/blaze-persistence-1.6.17-release.html[More...]
...
<!-- DeltaSpike Data 2.0 integration module -->
<dependency>
    <groupId>com.blazebit</groupId>
    <artifactId>blaze-persistence-integration-deltaspike-data-impl-2.0</artifactId>
    <version>${blaze-persistence.version}</version>
    <scope>runtime</scope>
</dependency>
