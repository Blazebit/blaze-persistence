...
[.releases]
|===
| 1.6.6         | 2022-01-29     | https://github.com/Blazebit/blaze-persistence/releases/download/1.6.6/blaze-persistence-dist-1.6.6.zip[*Download*, window="_blank"] | link:news/2022/blaze-persistence-1.6.6-release.html[More...]
...
<!-- Hibernate 6.0+ integration module -->
<dependency>
    <groupId>com.blazebit</groupId>
