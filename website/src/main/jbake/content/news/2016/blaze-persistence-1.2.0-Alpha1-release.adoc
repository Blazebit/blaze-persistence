...
* https://github.com/Blazebit/blaze-persistence/issues/202[*#202*, window="_blank"] Entity views can now reference their view root via <code>VIEW_ROOT</code>
...
* https://github.com/Blazebit/blaze-persistence/issues/191[*#191*, window="_blank"] + 216 Entity views will allow better collection usage
