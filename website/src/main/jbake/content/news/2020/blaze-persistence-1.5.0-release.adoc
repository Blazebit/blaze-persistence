...
If you want to know more about the new features or bug fixes, take a look into the https://github.com/Blazebit/blaze-persistence/blob/master/CHANGELOG.md#150[changelog, window="_blank"] for a full list of changes and improvements.
...
If you need long term support please consider the https://persistence.blazebit.com/support.html#_blaze_persistence_commercial_support[commercial support options].
