...
Take a look into the https://github.com/Blazebit/blaze-persistence/blob/master/CHANGELOG.md#162[changelog, window="_blank"] for a full list of changes and improvements.
