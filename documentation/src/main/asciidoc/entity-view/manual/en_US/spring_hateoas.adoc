...
Note that Spring HATEOAS 1.0+ requires at least Spring Data 2.2.
...
For a full example see the following https://github.com/Blazebit/blaze-persistence/blob/master/examples/spring-hateoas/[example project].