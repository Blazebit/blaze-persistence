...
link:{entity_view_jdoc}/persistence/view/EntityViewManager.html#save(jakarta.persistence.EntityManager,%20java.lang.Object)[`EntityViewManager.save(EntityManager em, Object view)`]
