...
For Spring-Data version 2.1 use the artifact with the suffix `2.1` instead and for Spring-Data 2.0 the `2.0` suffix.
If you still work with Spring Data 1.x you will have to use the following dependency.
