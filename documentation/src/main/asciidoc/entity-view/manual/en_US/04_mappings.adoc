...
In the future, a function `EMBEDDING_VIEW` will be introduced to be able to refer to the _embedding entity view_. Also see https://github.com/Blazebit/blaze-persistence/issues/367[#367] for more information on this.

// ==== EMBEDDING_VIEW
// TODO: add a macro for referencing the embedding view
