...
you can make use of the `@Self` annotation to inject a view of the state to a constructor. The previous example defined in a safe way would look like this:
