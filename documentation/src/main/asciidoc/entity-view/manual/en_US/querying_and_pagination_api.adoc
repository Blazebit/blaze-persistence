...
For a simple lookup by id there is also a convenience link:{entity_view_jdoc}/persistence/view/EntityViewManager.html#find(jakarta.persistence.EntityManager,%20java.lang.Class,%20java.lang.Object)[`EntityViewManager.find()`] method available
...
To get a _reference_ to an entity form an entity view one can use link:{entity_view_jdoc}/persistence/view/EntityViewManager.html#find(jakarta.persistence.EntityManager,%20java.lang.Object)[`EntityViewManager.getEntityReference()`]
...
NOTE: The GraphQL, JAX-RS and Spring MVC, as well as Spring WebFlux integrations have proper implementations for serializing and deserializing entity view types.
