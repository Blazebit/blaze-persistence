...
The call to link:{core_doc}/persistence/SetOperationBuilder.html#unionAll()[`unionAll()`] ends the previous query builder making any operations on it fail with an exception.
Finally link:{core_doc}/persistence/BaseOngoingSetOperationBuilder.html#endSet()[`endSet()`] ends the last query builder.
...
* link:{core_doc}/persistence/SetOperationBuilder.html#union()[`union()`] - `query1 UNION query2`
* link:{core_doc}/persistence/SetOperationBuilder.html#unionAll()[`unionAll()`] - `query1 UNION ALL query2`
* link:{core_doc}/persistence/SetOperationBuilder.html#intersect()[`intersect()`] - `query1 INTERSECT query2`
* link:{core_doc}/persistence/SetOperationBuilder.html#intersectAll()[`intersectAll()`] - `query1 INTERSECT ALL query2`
* link:{core_doc}/persistence/SetOperationBuilder.html#except()[`except()`] - `query1 EXCEPT query2`
* link:{core_doc}/persistence/SetOperationBuilder.html#exceptAll()[`exceptAll()`] - `query1 EXCEPT ALL query2`
...
CriteriaBuilder<Cat> cb =
    cbf.create(em, Cat.class)
        ...
        .end();
----
<1> The link:{core_doc}/persistence/BaseFinalSetOperationBuilder.html[result of `endSet()`] allows to apply sorting and limiting
...
// TODO: update links to functions
...
* link:{core_doc}/persistence/SetOperationBuilder.html#startUnion()[`startUnion()`] - `query1 UNION (...)`
* link:{core_doc}/persistence/SetOperationBuilder.html#startUnionAll()[`startUnionAll()`] - `query1 UNION ALL (...)`
* link:{core_doc}/persistence/SetOperationBuilder.html#startIntersect()[`startIntersect()`] - `query1 INTERSECT (...)`
* link:{core_doc}/persistence/SetOperationBuilder.html#startIntersectAll()[`startIntersectAll()`] - `query1 INTERSECT ALL (...)`
* link:{core_doc}/persistence/SetOperationBuilder.html#startExcept()[`startExcept()`] - `query1 EXCEPT (...)`
* link:{core_doc}/persistence/SetOperationBuilder.html#startExceptAll()[`startExceptAll()`] - `query1 EXCEPT ALL (...)`
...
FinalSetOperationCriteriaBuilder<Cat> cb =
    ...
    .endSet(); #<2>
----
<1> Ends the nested set operation group started by link:{core_doc}/persistence/SetOperationBuilder.html#startUnionAll()[`startUnionAll()`]
...
The left nesting is started by link:{core_doc}/persistence/CriteriaBuilderFactory.html#startSet(javax.persistence.EntityManager,%20java.lang.Class)[`startSet()`] which
more or less represents the _open parenthesis_. The parenthesis is then closed by calling `endSet()`.

At the beginning of every _nesting group_, you can start as many left nestings as you want by calling link:{core_doc}/persistence/StartOngoingSetOperationBuilder.html#startSet()[`startSet()`]
...
Ordering and limiting is also possible for nested set operation groups and can be realized by invoking the link:{core_doc}/persistence/OngoingSetOperationCriteriaBuilder.html#endSetWith()[`endSetWith()`] operation.
Calling `endSetWith()` is necessary to end the current query builder i.e. switch the context to the whole set operation group.
After applying ordering and limiting the set operation group has to be closed with link:{core_doc}/persistence/BaseOngoingFinalSetOperationBuilder.html#endSet()[`endSet()`].
