...
By default, the use of complex expressions is allowed in link:{core_doc}/persistence/OrderByBuilder.html#orderBy(java.lang.String,%20boolean,%20boolean)[`orderBy()`],
...
For convenience {projectname} also offers you shorthand methods for ordering link:{core_doc}/persistence/OrderByBuilder.html#orderByAsc(java.lang.String)[ascending]
or link:{core_doc}/persistence/OrderByBuilder.html#orderByDesc(java.lang.String)[descending] that make use of the default _null precedence_.
