...
@Entity // from jakarta.persistence
public class MyCte {
...
The left nesting is started by link:{core_jdoc}/persistence/CriteriaBuilderFactory.html#startSet(jakarta.persistence.EntityManager,%20java.lang.Class)[`startSet()`] which
