...
object and creating a link:{core_jdoc}/persistence/spi/CriteriaBuilderConfiguration.html#createCriteriaBuilderFactory(jakarta.persistence.EntityManagerFactory)[`CriteriaBuilderFactory`] from it.
