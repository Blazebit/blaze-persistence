...
NOTE: In a future version it might be possible to combine queries. For more information on that see https://github.com/Blazebit/blaze-persistence/issues/248[#248]
and https://github.com/Blazebit/blaze-persistence/issues/249[#249].
