...
During the building of a link:{core_jdoc}/persistence/spi/CriteriaBuilderConfiguration.html#createCriteriaBuilderFactory(jakarta.persistence.EntityManagerFactory)[`CriteriaBuilderFactory`]
...
The determination of the DBMS happens in implementations of link:{core_jdoc}/persistence/spi/EntityManagerFactoryIntegrator.html#getDbms(jakarta.persistence.EntityManagerFactory)[`EntityManagerFactoryIntegrator`]
