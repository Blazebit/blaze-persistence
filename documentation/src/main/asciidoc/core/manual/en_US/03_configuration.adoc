...
{projectname} can be configured by setting properties on a link:{core_doc}/persistence/spi/CriteriaBuilderConfiguration.html#setProperty(java.lang.String,%20java.lang.String)[`CriteriaBuilderConfiguration`]
object and creating a link:{core_doc}/persistence/spi/CriteriaBuilderConfiguration.html#createCriteriaBuilderFactory(javax.persistence.EntityManagerFactory)[`CriteriaBuilderFactory`] from it.

You can also set configuration properties on a per builder basis via the link:{core_doc}/persistence/CommonQueryBuilder.html#setProperty(java.lang.String,%20java.lang.String)[`setProperty(String, String)`] method.
