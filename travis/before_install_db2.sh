...
sudo /bin/sh -c '. /opt/IBM/db2/V9.7/instance/db2set DB2_COMPATIBILITY_VECTOR=MYS'
sudo /bin/sh -c '. /opt/IBM/db2/V9.7/instance/db2stop'
sudo /bin/sh -c '. /opt/IBM/db2/V9.7/instance/db2start'
