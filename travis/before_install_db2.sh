...
sudo /bin/sh -c '. /opt/IBM/db2/V9.7/bin/db2set DB2_COMPATIBILITY_VECTOR=MYS'
sudo /bin/sh -c '. /opt/IBM/db2/V9.7/bin/db2stop'
sudo /bin/sh -c '. /opt/IBM/db2/V9.7/bin/db2start'
