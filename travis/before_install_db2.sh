...
sudo /bin/sh -c '. ~db2inst1/sqllib/bin/db2set DB2_COMPATIBILITY_VECTOR=MYS'
sudo /bin/sh -c '. ~db2inst1/sqllib/bin/db2stop'
sudo /bin/sh -c '. ~db2inst1/sqllib/bin/db2start'
