...
import com.blazebit.persistence.examples.spring.data.webflux.filter.Filter;
import com.blazebit.persistence.examples.spring.data.webflux.model.Cat;
import com.blazebit.persistence.examples.spring.data.webflux.repository.CatRepository;
import com.blazebit.persistence.examples.spring.data.webflux.repository.CatViewRepository;
import com.blazebit.persistence.examples.spring.data.webflux.view.CatCreateView;
...
import com.blazebit.persistence.spring.data.webflux.KeysetConfig;
...
public class CatRestController {
    ...
    public Mono<ServerResponse> test(ServerRequest request) {
        Mono<TestDto> dto = request.bodyToMono(TestDto.class);
        return ServerResponse.ok().syncBody(dto.block().toString());
    }
