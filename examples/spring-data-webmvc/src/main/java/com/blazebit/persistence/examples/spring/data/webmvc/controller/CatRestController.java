...
package com.blazebit.persistence.examples.spring.data.webmvc.controller;

import com.blazebit.persistence.examples.spring.data.webmvc.filter.Filter;
import com.blazebit.persistence.examples.spring.data.webmvc.model.Cat;
import com.blazebit.persistence.examples.spring.data.webmvc.repository.CatRepository;
import com.blazebit.persistence.examples.spring.data.webmvc.repository.CatViewRepository;
import com.blazebit.persistence.examples.spring.data.webmvc.view.CatCreateView;
