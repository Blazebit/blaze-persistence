 ...
 * @since 1.6.7
 */
public class Hibernate7SessionInvocationHandler implements InvocationHandler {
    
    private final SharedSessionContractImplementor delegate;
    private final Object jdbcCoordinatorProxy;

    public Hibernate7SessionInvocationHandler(SharedSessionContractImplementor delegate, Object jdbcCoordinatorProxy) {
