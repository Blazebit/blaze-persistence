 ...
 * @since 1.0
 */
public class OraclePagePositionSQLMethod extends AbstractPagePositionSQLMethod {
    
    private static final PagePositionFunction function = new OraclePagePositionFunction();

    public OraclePagePositionSQLMethod() {
        super(function);
    }
