 ...
 * @since 1.0
 */
public class MySQLPagePositionSQLMethod extends AbstractPagePositionSQLMethod {
    
    private static final PagePositionFunction function = new MySQLPagePositionFunction();

    public MySQLPagePositionSQLMethod() {
        super(function);
    }
