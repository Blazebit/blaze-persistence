 ...
 * @since 1.0
 */
public class TransactSQLPagePositionSQLMethod extends AbstractPagePositionSQLMethod {
    
    private static final PagePositionFunction function = new TransactSQLPagePositionFunction();

    public TransactSQLPagePositionSQLMethod() {
        super(function);
    }
