 ...
 * @since 3.0
 */
public class FetchableFluentQueryBySpecification<S, R> extends FluentQuerySupport<S, R>
    implements FluentQuery.FetchableFluentQuery<R>, JpaSpecificationExecutor.SpecificationFluentQuery<R> {
    ...
    @Override
    public FetchableFluentQueryBySpecification<S, R> limit(int limit) {
    ...
    @Override
    public <NR> FetchableFluentQueryBySpecification<S, NR> as(Class<NR> resultType) {
    ...
    @Override
    public FetchableFluentQueryBySpecification<S, R> project(Collection<String> properties) {
