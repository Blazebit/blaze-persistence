...
interface MethodLookups {
    ...
    static class ReactiveTypeInteropMethodLookup extends RepositoryAwareMethodLookup {
         ...
         * converted into a different wrapper. Usually rx.Observable to {@link org.reactivestreams.Publisher}
         * conversion.
         *
         * @return
         */
         ...
         * a declared parameter. Usually reactor.core.publisher.Flux vs. {@link org.reactivestreams.Publisher}
         * conversion.
         *
         * @return
         */
