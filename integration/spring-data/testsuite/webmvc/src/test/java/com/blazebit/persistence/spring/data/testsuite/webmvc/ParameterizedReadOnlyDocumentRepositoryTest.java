...
@ContextConfiguration(classes = ParameterizedReadOnlyDocumentRepositoryTest.TestConfig.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_EACH_TEST_METHOD)
public class ParameterizedReadOnlyDocumentRepositoryTest extends AbstractSpringTest {
    ...
    public ParameterizedReadOnlyDocumentRepositoryTest(Class<? extends ReadOnlyDocumentRepository<?>> repositoryClass) {
    ...
    private boolean isEclipseLink() {
        return Arrays.asList(new SystemPropertyBasedActiveProfilesResolver().resolve(
            ParameterizedReadOnlyDocumentRepositoryTest.class)).contains("eclipselink");
    }
