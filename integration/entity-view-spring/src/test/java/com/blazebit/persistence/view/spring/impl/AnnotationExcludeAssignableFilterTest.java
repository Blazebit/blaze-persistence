...
import com.blazebit.persistence.view.spring.impl.views.SomeSuperInterface;
...
@ContextConfiguration(classes = AnnotationExcludeAssignableFilterTest.TestConfig.class)
public class AnnotationExcludeAssignableFilterTest {
    @Inject
    ...
    @Configuration
    @EnableEntityViews(excludeFilters = {
