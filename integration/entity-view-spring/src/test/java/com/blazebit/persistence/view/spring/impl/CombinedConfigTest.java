...
public class CombinedConfigTest {
    ...
    @Configuration
    @EnableEntityViews("com.blazebit.persistence.view.spring.impl.views.sub2")
    @ImportResource("/com/blazebit/persistence/view/spring/impl/entity-views-config.xml")
