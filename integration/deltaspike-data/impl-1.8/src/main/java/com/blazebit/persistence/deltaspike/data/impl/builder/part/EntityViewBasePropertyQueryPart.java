 ...
 * @since 1.2.0
 */
abstract class EntityViewBasePropertyQueryPart extends EntityViewQueryPart {
    static final String SEPARATOR = "_";

    void validate(String name, String method, EntityViewAwareRepositoryMetadata repo) {
