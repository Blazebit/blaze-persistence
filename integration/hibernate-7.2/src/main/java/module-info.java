...
module com.blazebit.persistence.integration.hibernate {
    ...
    provides org.hibernate.boot.spi.AdditionalMappingContributor with com.blazebit.persistence.integration.hibernate.Hibernate7AdditionalMappingContributor;
