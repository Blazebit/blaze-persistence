...
public class StaticPathCorrelationProvider implements CorrelationProvider, CorrelationProviderFactory {
    ...
    public StaticPathCorrelationProvider(String correlationPath) {
    ...
    public void applyCorrelation(CorrelationBuilder correlationBuilder, String correlationExpression) {
        ...
        String finalCorrelationPath = PrefixingQueryGenerator.prefix(expressionFactory, expressionFactory.createSimpleExpression(correlationPath, false), correlationExpression, false);
        correlationBuilder.correlate(finalCorrelationPath).setOnExpression("1=1");
    }
