...
public class CorrelatedBasicSubqueryListTupleTransformerFactory extends AbstractCorrelatedBasicSubqueryTupleTransformerFactory {
    ...
    public CorrelatedBasicSubqueryListTupleTransformerFactory(Class<?> criteriaBuilderResult, ManagedViewType<?> viewRoot, CorrelationProviderFactory correlationProviderFactory, int tupleIndex) {
