 ...
 * @since 1.2.0
 */
public class OptionalLongTypeConverter implements TypeConverter<Object, Object> {

    private static final Method OF;
    private static final Method GET_AS_LONG;
    private static final Method IS_PRESENT;
    private static final Object EMPTY;

    static {
        Method of = null;
        Method getAsLong = null;
        Method isPresent = null;
        Object empty = null;
        try {
            Class<?> c = Class.forName("java.util.OptionalLong");
            of = c.getMethod("of", long.class);
            getAsLong = c.getMethod("getAsLong");
    ...
    public Object convertToUnderlyingType(Object object) {
        try {
            ...
            return GET_AS_LONG.invoke(object);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
