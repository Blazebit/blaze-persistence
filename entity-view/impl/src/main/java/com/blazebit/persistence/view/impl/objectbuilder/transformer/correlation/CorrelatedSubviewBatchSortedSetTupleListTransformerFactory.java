 ...
 * @since 1.2.0
 */
public class CorrelatedSubviewBatchSortedSetTupleListTransformerFactory<T> extends AbstractCorrelatedSubviewBatchTupleListTransformerFactory<T> {

    private final Comparator<?> comparator;

    public CorrelatedSubviewBatchSortedSetTupleListTransformerFactory(ManagedViewType<T> managedViewType, ManagedViewType<?> viewRootType, String correlationResult, CorrelationProviderFactory correlationProviderFactory, String attributePath, int tupleIndex, int batchSize, Class<?> correlationBasisEntity, EntityViewManagerImpl evm, ExpressionFactory ef, String viewName, Comparator<?> comparator) {
