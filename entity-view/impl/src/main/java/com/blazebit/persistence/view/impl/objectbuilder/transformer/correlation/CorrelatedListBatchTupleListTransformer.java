...
public class CorrelatedListBatchTupleListTransformer extends AbstractCorrelatedCollectionBatchTupleListTransformer {
    ...
    public CorrelatedListBatchTupleListTransformer(Correlator correlator, Class<?> criteriaBuilderRoot, ManagedViewType<?> viewRootType, String correlationResult, CorrelationProviderFactory correlationProviderFactory, String attributePath, int tupleIndex, int batchSize, Class<?> correlationBasisType, Class<?> correlationBasisEntity, EntityViewConfiguration entityViewConfiguration) {
