 ...
 * @since 1.2.0
 */
public class CorrelatedListBatchTupleListTransformer extends AbstractCorrelatedCollectionBatchTupleListTransformer {

    public CorrelatedListBatchTupleListTransformer(ExpressionFactory ef, Correlator correlator, Class<?> criteriaBuilderRoot, ManagedViewType<?> viewRootType, String correlationResult, CorrelationProviderFactory correlationProviderFactory, String attributePath, String[] fetches,
