...
/**
 * Mostly copied from {@link javassist.bytecode.analysis.Analyzer} but uses a custom {@link Executor} to track local index origins for stack values.
 *
 * @author Jason T. Greene
 */
public class AssignmentAnalyzer implements Opcode {
