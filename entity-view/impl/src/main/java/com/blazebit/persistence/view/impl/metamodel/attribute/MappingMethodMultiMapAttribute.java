 ...
 * @since 1.5.0
 */
public class MappingMethodMultiMapAttribute<X, K, V, C extends Collection<V>> extends AbstractMethodMapAttribute<X, K, C> implements MappingAttribute<X, Map<K, C>>, MethodMultiMapAttribute<X, K, V, C> {
