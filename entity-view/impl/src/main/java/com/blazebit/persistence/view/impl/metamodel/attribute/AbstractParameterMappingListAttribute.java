 ...
 * @since 1.2.0
 */
public abstract class AbstractParameterMappingListAttribute<X, Y> extends AbstractParameterMappingPluralAttribute<X, List<Y>, Y> implements ListAttribute<X, Y> {
