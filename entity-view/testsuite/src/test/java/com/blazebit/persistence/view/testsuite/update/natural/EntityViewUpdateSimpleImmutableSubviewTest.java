...
public class EntityViewUpdateSimpleImmutableSubviewTest extends AbstractBookEntityViewTest<UpdatableBookReferenceView> {

    public EntityViewUpdateSimpleImmutableSubviewTest(FlushMode mode, FlushStrategy strategy, boolean version) {
        super(mode, strategy, version, UpdatableBookReferenceView.class);
    }
    ...
    public void testSimpleUpdate() {
        // Given
        final UpdatableBookReferenceView docView = evm.find(em, UpdatableBookReferenceView.class, e2.getId());
        BookIdView book123 = book(BookIdView.class, "123");
        BookIsbnView book456 = book(BookIsbnView.class, "456");
        clearQueries();
