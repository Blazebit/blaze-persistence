...
public interface PersonForCollectionsListSetMapMasterView extends PersonForCollectionsMasterView {

    @Override
    public Set<SubviewDocumentListSetMapView> getOwnedDocuments();
}
