...
public class ViewMetamodelTest extends AbstractEntityViewPersistenceTest {
    ...
    public void testMappingAttributeInterfaceInheritedInterfaceView() throws Exception {
        ...
        assertFalse(attribute.isMappingParameter());
    ...
    public void testMappingSubqueryInterfaceView() throws Exception {
        ...
        assertNull(attribute.getMapping());
        assertEquals(CountSubqueryProvider.class, attribute.getSubqueryProvider());
        assertTrue(attribute.isSubqueryMapping());
        assertFalse(attribute.isMappingParameter());
        assertEquals(Long.class, attribute.getJavaType());
    ...
    public void testMappingConstructor() throws Exception {
        ...
        assertEquals("age + 1", constructor.getParameterAttributes().get(0).getMapping());
        assertFalse(constructor.getParameterAttributes().get(0).isMappingParameter());
        ...
        assertEquals("contactPersonNumber", constructor.getParameterAttributes().get(1).getMapping());
        assertTrue(constructor.getParameterAttributes().get(1).isMappingParameter());
