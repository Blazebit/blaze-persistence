...
import com.blazebit.persistence.view.testsuite.update.subview.nested.mutableonly.model.UpdatableDocumentWithMapsView;
...
public class EntityViewUpdateNestedMutableOnlySubviewMapsTest extends AbstractEntityViewUpdateDocumentTest<UpdatableDocumentWithMapsView> {

    public EntityViewUpdateNestedMutableOnlySubviewMapsTest(FlushMode mode, FlushStrategy strategy, boolean version) {
