...
package com.blazebit.persistence.view.testsuite.fetch.multiset;
...
import com.blazebit.persistence.view.testsuite.fetch.multiset.model.DocumentMultisetFetchView;
import com.blazebit.persistence.view.testsuite.fetch.multiset.model.PersonMultisetFetchView;
 ...
 * @since 1.6.11
 */
public class MultisetFetchTypeTest extends AbstractEntityViewTest {
    ...
    public void testCollections() {
        ...
        CriteriaBuilder<PersonForMultisetFetch> criteria = cbf.create( em, PersonForMultisetFetch.class, "p")
                ...
                .orderByAsc("id");
        CriteriaBuilder<PersonMultisetFetchView> cb = evm.applySetting(EntityViewSetting.create(PersonMultisetFetchView.class), criteria);
